      ...
      <div className="bg-base-100 shadow-lg">
        ...
        <div className="md:mt-5 mb-10 pb-8">
          ...
          <div className="px-2 md:px-6 xl:px-8 flex flex-col md:flex-row justify-between gap-5 max-w-6xl mx-auto">
            <button
              className="md:w-1/2 btn btn-outline bg-[#DC0000] text-white hover:text-[#DC0000] hover:bg-white hover:border-[#DC0000] rounded-full"
              onClick={() => {
                const modal =
            ...
            <button className="md:w-1/2 btn btn-outline bg-[#DC0000] text-white hover:text-[#DC0000] hover:bg-white hover:border-[#DC0000] rounded-full">
