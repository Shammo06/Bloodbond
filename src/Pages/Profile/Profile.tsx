                ...
                <div className="md:flex  pt-5 text-base">
                    <div className="md:w-1/2 space-y-3">
                        <div className="">
                            ...
                            <span className="font-semibold">{User?.donor?.bloodGroup}</span>
                        </div>
                        <div className="">
                            <p className="font-semibold text-gray-500">Last Donation Date: </p>
                            <span className="font-semibold">{User?.donor?.lastDonationDate.slice(0, 10)}</span>
                        </div>
                        <div className=""><p className="font-semibold text-gray-500">Phone: </p>
                            <span className="font-semibold">{User?.donor?.phone}</span></div>
                    </div>
                    <div className="space-y-3">
                        <div className="">
